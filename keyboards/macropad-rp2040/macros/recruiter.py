...
#TODO: should the blurb be read from a file on PC/host?
interestedBlurb = '''Hi,

Thanks for reaching out to me about this position.

It sounds interesting, especially the CI/Java aspects.

Although, I cannot relocate from San Antonio, TX.

Can you keep me in mind for remote positions, please?
...
app = {                          # REQUIRED dict, must be named 'app'
    'name' : 'Recruiter', # Application name
